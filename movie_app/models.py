...
class Movie(models.Model):
    ...
    cinema = models.ForeignKey(Theater, related_name='movie')
...
class Showtime(models.Model):
    ...
    show_section = models.ForeignKey(Movie, related_name='show_time')
...
class Seat(models.Model):
    ...
    show_num = models.ForeignKey(Showtime, related_name='seat_number')
